...
exe = EXE(pyz,
          ...
          a.binaries,
          a.datas,
          name=os.path.join('build/electrum-grs/electrum-grs', 'electrum-grs_osx.bin'),
          debug=True,
          strip=None,
          upx=False,
...
app = BUNDLE(coll,
        name=os.path.join('dist', 'Electrum-GRS.app'),
        appname="Electrum-GRS",
	 icon='electrum-grs.icns',
